package br.edu.utfpr.tdsapi.tdsapi.exceptionhandler;
...
public class TdsExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    public ResponseEntity<Object> handleDataIntegrityViolatioException(DataIntegrityViolationException ex, WebRequest request){
    ...
    private List<Erro> criarListadeErros(BindingResult bindingResult){
        ...
        for (FieldError fieldError : bindingResult.getFieldErrors()){
            String mensagemdoUsuario = messageSource.getMessage(fieldError, LocaleContextHolder.getLocale());
